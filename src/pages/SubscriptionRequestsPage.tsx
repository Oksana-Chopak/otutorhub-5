                  ...
                  <CardContent className="p-5 space-y-4">
                    <div className="flex flex-wrap items-start justify-between gap-3">
                      <div className="flex items-center gap-3 min-w-0">
                        ...
                        <p className="text-[14px]" style={{ color: "var(--sub,#62677E)", marginTop: 2 }}>
                    ...
                    {r.message && (
                      <div className="rounded-[13px] p-3 text-[14px]" style={{ background: "var(--ds-surface2,#fbfbfc)", border: "1px solid var(--ds-border,#eceef3)", color: "var(--ds-txt,#0f0f1a)" }}>
                        <div className="mb-1.5 inline-flex items-center gap-1.5 text-[14px]" style={{ color: "var(--sub,#62677E)", fontFamily: "Inter, system-ui, sans-serif", fontWeight: 700 }}>
                    ...
                    {r.manager_response && (
                      <div className="rounded-[13px] p-3 text-[14px]" style={{ border: "1px solid var(--ds-border,#eceef3)" }}>
                        <div className="mb-1.5 text-[14px]" style={{ color: "var(--sub,#62677E)", fontFamily: "Inter, system-ui, sans-serif", fontWeight: 700 }}>
