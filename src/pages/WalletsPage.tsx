          ...
          <>
            ...
            <div className="hidden md:block overflow-x-auto rounded-[16px]" style={{ border: "1px solid #eceef3" }}>
              <table className="w-full text-[15px]">
                <thead className="text-[13px] uppercase" style={{ background: "#fbfbfc", color: "#9398b0", fontFamily: "Inter, system-ui, sans-serif", fontWeight: 700 }}>
                  <tr>
                ...
                <tbody>
                  {filtered.map((r) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3" style={{ color: "#9398b0" }}>{r.tutor_name}</td>
                      ...
                      <td className="px-4 py-3 text-[13px]" style={{ color: "#9398b0" }}>
