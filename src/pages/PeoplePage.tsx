...
export default function PeoplePage() {
  ...
  const renderUserCard = (u: UserRow, accent?: "primary" | "secondary") => {
    ...
    <div
      key={u.id}
      className={`overflow-hidden rounded-[16px] border-[0.5px] bg-card p-3 sm:p-3.5 transition-all cursor-pointer ${
        u.archived_at
      ...
      <div className="flex items-start justify-between gap-2 lg:items-center">
        ...
        >
          ...
          <div className="min-w-0 flex-1">
            ...
            {!isExpanded && (
              <p className="mt-0.5 text-[15px]" style={{ color: "var(--sub, #666b82)" }}>
                {u.is_pending
                  ? (u.email || u.phone || "")
  ...
  return (
    <>
      ...
      {loading ? (
        ...
        /* Аудит 03.09: цей блок не дивився на loadError — під повідомленням
           про збій одразу малювалось упевнене «Нікого не знайдено». */
        <>
            ...
            <div style={{ borderRadius: 16, padding: 14, background: "linear-gradient(135deg,#FFF7E6,#FFEFD0)", border: "1px solid rgba(245,181,68,.4)" }}>
              ...
              <div className="grid grid-cols-[1fr_8rem] gap-2">
                <Input
                  ...
                  className="h-[52px] bg-card text-[18px] font-bold rounded-[13px]"
              ...
              <>
                ...
                {tutorProgress && (
                  <div className="px-4 py-3 border-b border-border">
                    ...
                    <div className="h-1.5 w-full rounded-full" style={{ background: "var(--border,var(--ds-border,#eceef3))" }}>
                      <div
