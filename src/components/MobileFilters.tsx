        ...
        <CollapsibleTrigger asChild>
          {compact ? (
            ...
            >
              ...
              {activeCount > 0 && !open && (
                <span className="absolute -right-1 -top-1 inline-flex h-4 min-w-[16px] items-center justify-center rounded-full bg-primary px-1 text-[12px] font-semibold text-primary-foreground shadow-sm">
                  {activeCount}
                </span>
              )}
            </Button>
            ...
            >
              <span className="flex items-center gap-2">
                ...
                {t("filters.label")}
                {activeCount > 0 && (
                  <span className="inline-flex h-5 min-w-[20px] items-center justify-center rounded-full bg-primary px-1.5 text-[12px] font-semibold text-primary-foreground">
                    {activeCount}
                  </span>
                )}
              </span>
