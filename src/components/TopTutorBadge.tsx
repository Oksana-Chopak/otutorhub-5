  ...
  return (
    <Card className="flex items-center gap-4 border-amber-400/40 bg-gradient-to-r from-amber-50 to-yellow-50 p-4 dark:from-amber-950/30 dark:to-yellow-950/20">
      ...
      <div className="min-w-0">
        ...
        <p className="text-[14px] text-muted-foreground">{t("tutorDelight.topTutorDesc")}</p>
      </div>
      <span className="ml-auto shrink-0 rounded-full bg-amber-400/20 px-2.5 py-1 text-[14px] font-bold text-amber-600">
        TOP {display}%
      </span>
    </Card>
  );
