  ...
  return (
    <div
      ...
      style={{
        ...
        // 15.09: банер стояв НАД діалогами (60 проти 50) і знизу — рівно там,
        // де в нижнього листа кнопка «Далі». Робот показав це на анкеті підбору
        // з лендінгу: у людини, яка ще не відповіла на банер, кнопки під ним
        // просто не було куди натиснути, а на мобільному ВСІ форми застосунку —
        // нижні листи. Тепер банер вище сторінки, але нижче шару діалогів:
        // поки форма відкрита, він чекає під нею і нічого не перекриває.
        zIndex: 45,
