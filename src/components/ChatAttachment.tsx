...
export function ChatAttachment({ attachment, mine }: Props) {
        ...
        >
          {loading || !url ? (
            <div className="flex aspect-video w-full max-w-[240px] items-center justify-center bg-muted/40">
              {error ? (
                <span className="text-[14px] text-destructive px-2 text-center">{error}</span>
              ) : (
            ...
            {url && (
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-between gap-2 px-1">
                  <span className="truncate text-[14px] text-muted-foreground" title={attachment.file_name}>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex shrink-0 items-center gap-1 rounded-[12px] border border-border bg-background px-2 py-1 text-[14px] hover:bg-accent"
                  >
  ...
  return (
    <a
      ...
      className={cn(
        "flex w-full items-center gap-2 rounded-[12px] border px-2 py-1.5 text-left text-[14px] transition-colors",
        mine
